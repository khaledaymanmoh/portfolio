...
const projects = [
    {
        ...
        description: "Developed this thorough out The Creative React Course by Dev Ed, my favorite instructor on the internet. The project is very interesting and included the implementation of a variety of concepts and features which enhanced my journey in using ReactJS. ",
